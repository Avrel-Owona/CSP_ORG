		...
		<section className="bg-gray-100">
			...
			<section className="flex px-5 sm:px-7 mt-20">
				<div className="w-3/6">
					<img
						src="cover.jpg"
						className="relative w-full object-cover after:content-[''] after:absolute after:-left-4 after:h-20 after:w-20 after:bg-teal-700"
					/>
				</div>
				<div className="flex w-3/6 flex-col pl-5">
					...
					<h2 className="italic text-3xl font-medium mt-8">
						...
						sunt atque nemo et harum dolorum aspernatur!
					</h2>
					<p className="mt-5 text-base text-gray-500">
						...
						doloremque velit aspernatur. Lorem ipsum, dolor sit amet consectetur
						adipisicing elit. Veniam, commodi qui. Reprehenderit voluptatibus
						ratione cum nisi. Quia quisquam quas dolorum voluptate a voluptatum,
						iusto nisi reiciendis, assumenda officiis enim? Laboriosam! Lorem
						ipsum dolor sit amet consectetur, adipisicing elit. Quas veniam
						dolorem laboriosam velit necessitatibus. Facilis impedit repellendus
						officiis sapiente magnam sint facere, distinctio optio suscipit
						quisquam laborum maiores. Iure, quam!
					</p>
